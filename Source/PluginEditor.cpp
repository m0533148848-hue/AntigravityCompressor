    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    // הגדלנו את המסך משמעותית כדי שיהיה מקום לגרפיקה
    setSize (600, 750);
}
